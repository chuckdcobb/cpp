...
void mainmenu()
{
    ...
    default:
        gotoxy(33,40);
        cout<<"Undefined Choice Press any key to return to Main Menu";
        getch();
        mainmenu();
    }
...

{
...

    {
        ...
        cout <<"Enter Class for the Modification of the University Fees : " ;
...

    {
        ...
        cout <<"Do you want to modify the university fee(s)? (y/n) : " ;
...

{
...

    {
        ...
        cout <<"Enter Class to see the Fees : " ;
...

    {
...

        {
            ...
            cout <<"NAME SHOULD NOT BE GREATER THAN 25 CHARACTERS" ;
...
void FEE::HELP()
{
    ...
    cout<<"This program summarizes the university fees"<<endl;
